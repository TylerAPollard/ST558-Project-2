...
This contingency table show what count range of casual riders utilized the bikeshare service on working day versus non-working day. Intuitively we'd suspect that there would more casual riders on non-workingday than working day, this table can show us whether it's true or not.  
...
## Summary Tables
### Feeling Temperature
This summary table shows the spread of feeling temperatures for each year. The table includes the 5 number summary along with mean and standard deviation, which gives insight to the range of feeling temperatures riders experienced. 
...
kable(atemp.summary, digits = 2, caption = "Feeling Temperature")
```
...
ggplot(hour.training.data, aes(x = hr, y = cnt)) + 
  ...
  labs(title = "Count of riders for every hour",
